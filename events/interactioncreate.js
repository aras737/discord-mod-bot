      ...
      // ✅ BİLET SİSTEMİ (SELECT MENU)
        ...
        if (interaction.customId === 'ticket_menu') {
          ...
          try {
            ...
            const supportRoleId = 'DESTEK_ROLE_ID'; // 🎯 Burayı kendi sunucuna göre değiştir!
            ...
            console.error('Bilet hatası:', err);
            return interaction.reply({
